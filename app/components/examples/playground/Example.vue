...
<template>
  ...
  <div class="hidden h-full flex-col md:flex">
    <div class="flex flex-col items-start justify-between py-4 container md:h-16 sm:flex-row sm:items-center space-y-2 sm:space-y-0">
      <h2 class="text-lg font-semibold">
        Playground
      </h2>
      <div class="ml-auto w-full flex sm:justify-end space-x-2">
    ...
    <Tabs default-value="complete" class="flex-1">
      <div class="h-full py-6 container">
        <div class="grid h-full items-stretch gap-6 md:grid-cols-[minmax(0,1fr)_200px]">
          <div class="hidden flex-col md:order-2 sm:flex space-y-4">
          ...
          <div class="md:order-1">
            <TabsContent value="complete" class="mt-0 border-0 p-0">
              <div class="h-full flex flex-col space-y-4">
                <Textarea
                  ...
                  class="min-h-[400px] flex-1 p-4 lg:min-h-[700px] md:min-h-[700px]"
                />
            ...
            <TabsContent value="insert" class="mt-0 border-0 p-0">
              <div class="flex flex-col space-y-4">
                <div class="grid grid-rows-2 h-full gap-6 lg:grid-cols-2 lg:grid-rows-1">
                  <Textarea
                    placeholder="We're writing to [inset]. Congrats from OpenAI!"
                    class="h-full min-h-[300px] lg:min-h-[700px] xl:min-h-[700px]"
                  />
                  <div class="border rounded-md bg-muted" />
                </div>
                <div class="flex items-center space-x-2">
                  <Button>Submit</Button>
                  <Button variant="secondary">
            ...
            <TabsContent value="edit" class="mt-0 border-0 p-0">
              <div class="flex flex-col space-y-4">
                <div class="grid h-full gap-6 lg:grid-cols-2">
                  ...
                  <div class="mt-[21px] min-h-[400px] border rounded-md bg-muted lg:min-h-[700px]" />
                </div>
                <div class="flex items-center space-x-2">
                  <Button>Submit</Button>
                  <Button variant="secondary">
