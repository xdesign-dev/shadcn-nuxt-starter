...
const columns: ColumnDef<Payment>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => {
      ...
      }, ['Email', h(Icon, { name: 'lucide:chevrons-up-down', class: 'ml-2 h-4 w-4' })])
    },
    cell: ({ row }) => h('div', { class: 'lowercase' }, row.getValue('email')),
  },
  {
    accessorKey: 'amount',
    header: () => h('a', { class: 'block text-right' }, 'Amount'),
    cell: ({ row }) => {
          ...
          <DropdownMenu>
            <DropdownMenuTrigger as-child>
              <Button variant="outline" class="ml-auto">
                Columns <Icon name="lucide:chevron-down" class="ml-2 h-4 w-4" />
              </Button>
            </DropdownMenuTrigger>
