    ...
    <CardContent class="grid gap-6">
      <RadioGroup default-value="card" class="grid grid-cols-3 gap-4">
        <div>
          ...
          <Label
            for="card"
            class="flex flex-col items-center justify-between border-2 border-muted rounded-md bg-popover p-4 [&:has([data-state=checked])]:border-primary hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary"
          >
            <svg
